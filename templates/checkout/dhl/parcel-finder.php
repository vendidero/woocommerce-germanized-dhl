            ...
            <div id="dhl-parcel-finder">
                <form id="dhl-parcel-finder-form" method="post">
                    <p class="form-row form-field small">
                        <input type="text" name="dhl_parcelfinder_postcode" class="input-text" placeholder="<?php echo esc_attr_x(  'Postcode', 'dhl', 'woocommerce-germanized-dhl' ); ?>" id="dhl-parcelfinder-postcode" />
                    </p>
                    <p class="form-row form-field small">
                        <input type="text" name="dhl_parcelfinder_city" class="input-text" placeholder="<?php echo esc_attr_x(  'City', 'dhl', 'woocommerce-germanized-dhl' ); ?>" id="dhl-parcelfinder-city" />
                    </p>
                    <p class="form-row form-field large">
                        <input type="text" name="dhl_parcelfinder_address" class="input-text" placeholder="<?php echo esc_attr_x(  'Address', 'dhl', 'woocommerce-germanized-dhl' ); ?>" id="dhl-parcelfinder-address" />
                    </p>
                    ...
                    <p class="form-row form-field finder-pickup-type packstation <?php echo ( ! $is_packstation_enabled ? 'hidden' : '' ); ?>" data-pickup_type="packstation">
                        ...
                        <label for="dhl-packstation-filter"><?php echo esc_attr_x(  'Packstation', 'dhl', 'woocommerce-germanized-dhl' ); ?></label>
                    ...
                    <p class="form-row form-field finder-pickup-type parcelshop <?php echo ( ! $is_parcelshop_enabled ? 'hidden' : '' ); ?>" data-pickup_type="parcelshop">
                        ...
                        <label for="dhl-parcelshop-filter"><?php echo esc_attr_x(  'Parcelshop', 'dhl', 'woocommerce-germanized-dhl' ); ?></label>
                    ...
                    <p class="form-row form-field finder-pickup-type postoffice <?php echo ( ! $is_postoffice_enabled ? 'hidden' : '' ); ?>" data-pickup_type="postoffice">
                        ...
                        <label for="dhl-postoffice-filter"><?php echo esc_attr_x(  'Postoffice', 'dhl', 'woocommerce-germanized-dhl' ); ?></label>
                    ...
                    <p id="dhl-search-button" class="form-row form-field small">
                        <input type="submit" class="button" name="apply_parcel_finder" value="<?php echo esc_attr_x(  'Search', 'dhl', 'woocommerce-germanized-dhl' ); ?>" />
                    </p>
