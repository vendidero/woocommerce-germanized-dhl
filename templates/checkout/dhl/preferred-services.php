...
Please choose your preferred delivery option.', 'dhl', 'woocommerce-germanized-dhl' ); ?>
            </div>
        </div>
            ...
            <div class="dhl-preferred-service-item dhl-preferred-service-day">
                ...
                <?php if ( ! empty( $preferred_day_cost ) ) : ?>
                    <div class="dhl-preferred-service-cost">
                        <?php printf( _x( 'There is a surcharge of %s incl. VAT for this service.*', 'dhl', 'woocommerce-germanized-dhl' ), wc_price( $preferred_day_cost ) ); ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="dhl-preferred-service-data">
                    <ul class="dhl-preferred-location-types">
                        <li>
                            ...
                            <label for="dhl-preferred_location-none"><?php _ex( 'None', 'dhl location context', 'woocommerce-germanized-dhl' ); ?></label>
                        </li>
                        <?php if ( $preferred_location_enabled ) : ?>
                            <li>
                                ...
                                <label for="dhl-preferred_location-place"><?php _ex( 'Location', 'dhl', 'woocommerce-germanized-dhl' ); ?></label>
                            </li>
                        <?php endif; ?>
	                    <?php if ( $preferred_neighbor_enabled ) : ?>
                            <li>
                                ...
                                <label for="dhl-preferred_location-neighbor"><?php _ex( 'Neighbor', 'dhl', 'woocommerce-germanized-dhl' ); ?></label>
                            </li>
	                    <?php endif; ?>
                    </ul>
