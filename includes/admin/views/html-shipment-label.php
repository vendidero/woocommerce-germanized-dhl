	        ...
	        <?php if ( $dhl_label ) : ?>
                <div class="shipment-dhl-label-actions-wrapper shipment-dhl-label-actions-download">
                    ...
                    <?php if ( 'return' === $dhl_label->get_type() ) : ?>
                        <a class="send-shipment-label email" href="#" data-label="<?php echo esc_attr( $dhl_label->get_id() ); ?>"><?php _ex(  'Send to customer', 'dhl', 'woocommerce-germanized-dhl' ); ?></a>
                    <?php endif; ?>

                    <a class="remove-shipment-label delete" data-label="<?php echo esc_attr( $dhl_label->get_id() ); ?>" href="#"><?php _ex(  'Delete', 'dhl', 'woocommerce-germanized-dhl' ); ?></a>
                </div>
	        <?php else: ?>
                <div class="shipment-dhl-label-actions-wrapper shipment-dhl-label-actions-create">
                    <a class="button button-secondary create-shipment-label" href="#" title="<?php _ex(  'Create new DHL label', 'dhl', 'woocommerce-germanized-dhl' ); ?>"><?php _ex( 'Create label', 'dhl', 'woocommerce-germanized-dhl' ); ?></a>
