...
<?php if ( empty( $im_products ) ) : ?>
    ...
    <div class="notice-wrapper">
        <div class="notice is-dismissible notice-warning">
            <p><?php printf( __( 'Sorry but none of your selected <a href="%s">Deutsche Post Products</a> is available for this shipment. Please verify your shipment data (e.g. weight) and try again.', 'dhl', 'woocommerce-germanized-dhl' ), admin_url( \Vendidero\Germanized\DHL\Admin\Settings::get_settings_url( 'internetmarke' ) ) ); ?></p>
        </div>
    </div>
<?php else: ?>
