...
class ShippingMethodPaket extends WC_Shipping_Method {
    ...
    public function __construct( $instance_id = 0 ) {
        ...
        $this->id                 = 'gzd_dhl_paket';
        $this->method_title       = __( 'DHL Paket', 'woocommerce-germanized-dhl' );
        $this->method_description = __( 'Below you will find all functions for controlling, preparing and processing your shipment with DHL Paket.', 'woocommerce-germanized-dhl' );
