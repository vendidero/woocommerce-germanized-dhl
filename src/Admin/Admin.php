...
class Admin {
	...
	public static function legacy_meta_box() {
		...
		if ( ! empty( $meta ) ) {
			...
			echo '<a class="button button-primary" target="_blank" href="' . esc_url( self::get_legacy_label_download_url( $order_id ) ) . '">' . _x( 'Download label', 'dhl', 'woocommerce-germanized-dhl' ) . '</a>';
		}
	}
